...
- controla as cartas viradas;
- valida pares de cartas;
- contabiliza tentativas;
- identifica automaticamente o fim do jogo, exibindo o resultado final.
...
- Caso contrário, retornam ao estado fechado após um pequeno intervalo;
...
- **CSS3** — Estilização, layout com Grid e tela de finalização;
